...
namespace SportsZoneWebAPI.Mappings.MappingProfiles
{
    public class SecurityMapping : Profile
    {
        public SecurityMapping()
        {
            ...
            .ForMember(dest => dest.Password, opt => opt.MapFrom(src => Helper.HashItemToBytes(src.Password)))
            .ForMember(dest => dest.Answer, opt => opt.MapFrom(src => Helper.HashItemToBytes(src.Answer)))
