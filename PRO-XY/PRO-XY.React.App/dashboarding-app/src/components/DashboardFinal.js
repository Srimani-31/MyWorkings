  ...
  return (
    <div className="container mx-auto mt-8">
      ...
      <div className="flex mb-4">
        ...
        {/* Total Profits Widget */}
        <div className="flex-1 mx-2">
          <div className="bg-green-200 p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-bold mb-2 text-green-800">Total Profit</h3>
            <p className="text-xl text-green-900">&#36;{totalProfits}</p>
          </div>
        </div>
        {/* Total Profit Percentage Widget */}
        <div className="flex-1 mx-2">
          <div className="bg-yellow-200 p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-bold mb-2 text-yellow-800">Profit %</h3>
